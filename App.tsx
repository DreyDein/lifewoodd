...
const translations = {
  en: {
    ...
    careers: {
      ...
      cvLabel: 'CV / Resume',
      cvHelper: 'PDF, DOC, DOCX — Max 5MB',
      cvDrag: 'Drag & drop your CV here',
      cvBrowse: 'click to browse',
  ...
  fil: {
    ...
    contactModal: { fullName: 'Buong pangalan mo', email: 'email@company.com', inquiryType: 'Uri ng Inquiry', inquiryGeneral: 'Pangkalahatang Inquiry', inquiryServices: 'Mga Serbisyo', inquiryPartnership: 'Pakikipag-partner', message: 'Paano kami makakatulong?', send: 'Ipadala ang Mensahe', closeButton: 'Isara', successMessage: 'Matagumpay na naipadala ang mensahe.' },
  ...
  ja: {
    ...
    contactModal: { fullName: 'お名前', email: 'email@company.com', inquiryType: 'お問い合わせ種別', inquiryGeneral: '一般お問い合わせ', inquiryServices: 'サービスについて', inquiryPartnership: 'パートナーシップ', message: 'どのようにお手伝いできますか？', send: 'メッセージを送信', closeButton: '閉じる', successMessage: 'メッセージを送信しました。' },
  ...
  ko: {
    ...
    contactModal: { fullName: '이름', email: 'email@company.com', inquiryType: '문의 유형', inquiryGeneral: '일반 문의', inquiryServices: '서비스 문의', inquiryPartnership: '파트너십 문의', message: '무엇을 도와드릴까요?', send: '메시지 보내기', closeButton: '닫기', successMessage: '메시지가 성공적으로 전송되었습니다.' },
  ...
  zh: {
    ...
    contactModal: { fullName: '您的姓名', email: 'email@company.com', inquiryType: '咨询类型', inquiryGeneral: '一般咨询', inquiryServices: '服务咨询', inquiryPartnership: '合作咨询', message: '我们可以如何帮助您？', send: '发送消息', closeButton: '关闭', successMessage: '消息发送成功。' },
  ...
  es: {
    ...
    contactModal: { fullName: 'Tu nombre completo', email: 'email@company.com', inquiryType: 'Tipo de consulta', inquiryGeneral: 'Consulta general', inquiryServices: 'Servicios', inquiryPartnership: 'Alianzas', message: 'Como podemos ayudarte?', send: 'Enviar mensaje', closeButton: 'Cerrar', successMessage: 'Mensaje enviado con exito.' },
